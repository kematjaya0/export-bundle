 ...
 */
class Kematjaya_ExportBundle_Test_AppKernelTestTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Kematjaya\\Export\\Manager\\ManagerInterface' => 'getManagerInterfaceService',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Kematjaya_ExportBundle_Test_AppKernelTestTestDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                'ExportBundle' => 'Kematjaya\\ExportBundle\\ExportBundle',
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
            ],
            'kernel.bundles_metadata' => [
                'ExportBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/src'),
                    'namespace' => 'Kematjaya\\ExportBundle',
                ],
                'FrameworkBundle' => [
            ...
            'kernel.container_class' => 'Kematjaya_ExportBundle_Test_AppKernelTestTestDebugContainer',
